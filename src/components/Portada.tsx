...
export const Portada = () => {
  ...
  useEffect(() => {
    fetch(`https://backend-crox.up.railway.app/api/publicaciones?page=1&limit=1`)
  ...
  return (
    <>
      ...
      <div className="w-full px-4">
        ...
        >
          <h1
            className="text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]"
          >
          {data.web_titulo}
            </h1>
          <p
            className="mx-auto mt-3 mb-9 max-w-[600px] font-medium text-base text-white sm:text-lg sm:leading-[1.44]"
          >
          {data.web_mini_desc}
          </p>
          <ul className="mb-1 flex gap-5 flex-wrap items-center justify-center">
            <li>
              <a
                href={`/publicacion/?id=${data.web_id}`}
